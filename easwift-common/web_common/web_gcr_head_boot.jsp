...
<script type="text/javascript" src="${basePath}/common/js/validation_idcard.js"></script>
<script type="text/javascript" src="${basePath}/web_common/js/highcharts.js"></script>
<script type="text/javascript" src="${basePath}/web_common/js/no-data-to-display.js"></script>
...
function closeFun(){
	$(window.parent.document).find("#open_modal_close").click();
}
