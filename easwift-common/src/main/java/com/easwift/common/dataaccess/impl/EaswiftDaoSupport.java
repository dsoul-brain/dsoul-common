...
import com.easwift.common.dataaccess.api.DaoException;
import com.easwift.common.dataaccess.api.IdGenerator;
import com.easwift.common.dataaccess.api.SqlDescription;
import com.easwift.common.utils.EaswiftMapUtils;
 ...
 */
@Transactional
public class EaswiftDaoSupport extends EaswiftAbstractDao {

	private static final Logger logger = Logger.getLogger(EaswiftDaoSupport.class);
	...
	public List<Map<String, Object>> selectForCamelCaseMap(String statementName) throws DaoException {
		...
		if (ClassUtils.isAssignable(element.getClass(), Map.class)) {
			EaswiftMapUtils.keyToCamelCase((List<Map<String, Object>>) resultList);
