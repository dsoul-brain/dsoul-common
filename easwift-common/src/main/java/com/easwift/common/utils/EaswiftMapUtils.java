package com.easwift.common.utils;
...
public class EaswiftMapUtils {
	...
	public static void keyToCamelCase(Map<String, Object> map, String separator) {
		for (Entry<String, Object> entry : map.entrySet()) {
			...
			map.put(EaswiftStringUtils.toCamelCase(entry.getKey(), separator), entry.getValue());
		}
	}
