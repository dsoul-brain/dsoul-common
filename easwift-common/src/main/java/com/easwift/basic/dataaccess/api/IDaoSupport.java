...
import com.easwift.basic.dataaccess.exception.DaoException;

/**
 * 
 * @descrpiton [Dao层通用接口]
 * @author [dingwei.tang]
 * @date [2017年2月9日 下午1:27:20]
 */
public interface IDaoSupport {
	 ...
	 */
	public abstract SqlDescription getNamedSql(String statementName, Object parameterObject);
	 ...
	 * @return 加载的持久化对象
	 */
	public abstract <T> T load(Class<T> entityClass, Serializable id, boolean lazy);
	 ...
	 * @return HQL语句执行后返回的结果
	 */
	public abstract Object executeForObject(String queryString, Object... values);
	 ...
	 * @return 查询语句返回的结果
	 */
	public abstract Object findSingle(String queryString, Object value) throws DaoException;
	 ...
	 * @return 查询语句返回的结果
	 */
	public abstract Object findSingle(String queryString, Object... values) throws DaoException;
	 ...
	 * @return 查询语句返回的结果集
	 */
	public abstract List<?> findForList(String queryString, int firstResult, int maxResults);
	 ...
	 * @return 查询语句返回的结果
	 */
	public abstract List<?> findForList(String queryString, int firstResult, int maxResults, Object value);
	 ...
	 * @return 查询语句返回的结果集
	 */
	public abstract List<?> findForList(String queryString, int firstResult, int maxResults, Object... values);
	 ...
	 * @return 查询语句返回的结果
	 */
	public abstract Object findByExampleSingle(Object exampleEntity) throws DaoException;

	/**
	 * {@link EaswiftDaoSupport#findEqual(Class, Object, Map, String[], int, int)}
	 * 查询单条记录, 如果查询到多条抛出异常
	 */
	public abstract <T> T findEqualSingle(Class<T> entityClass, Object paramObj, Map<String, String> mapping,
	 ...
	 * 查询单条记录, 如果查询到多条抛出异常
	 */
	public abstract <T> T findEqualSingle(Class<T> entityClass, Object paramObj, String[] ignores) throws DaoException;

	/**
	 * {@link EaswiftDaoSupport#findEqual(Class, Object, Map, String[], int, int)}
	 * 查询单条记录, 如果查询到多条抛出异常
	 */
	public abstract <T> T findEqualSingle(Class<T> entityClass, Object paramObj) throws DaoException;

	/**
	 * {@link EaswiftDaoSupport#findEqual(Class, Object, Map, String[], int, int)}
	 * 查询单条记录, 如果查询到多条抛出异常
	 */
	public abstract Object findEqualSingle(Object entity, String[] ignores) throws DaoException;
	 ...
	 * @return 查询语句返回的结果
	 */
	public abstract <T> List<T> findEqual(Class<T> entityClass, Object paramObj, Map<String, String> mapping,
	 ...
	 * {@link EaswiftDaoSupport#findEqual(Class, Object, Map, String[], int, int)}
	 */
	public abstract <T> List<T> findEqual(Class<T> entityClass, Object paramObj, String[] ignores, int firstResult,
			int maxResults);

	/**
	 * {@link EaswiftDaoSupport#findEqual(Class, Object, Map, String[], int, int)}
	 */
	public abstract <T> List<T> findEqual(Class<T> entityClass, Object paramObj, int firstResult, int maxResults);

	/**
	 * {@link EaswiftDaoSupport#findEqual(Class, Object, Map, String[], int, int)}
	 */
	public abstract List<?> findEqual(Object entity, String[] ignores, int firstResult, int maxResults);

	/**
	 * {@link EaswiftDaoSupport#findEqual(Class, Object, Map, String[], int, int)}
	 */
	public abstract List<?> findEqual(Object entity, int firstResult, int maxResults);
	 ...
	 * 不带分页
	 */
	public abstract <T> List<T> findEqual(Class<T> entityClass, Object paramObj, String[] ignores);
	 ...
	 *             产生内部转换异常时抛出
	 */
	public abstract Object updateIgnoreNull(Object entity, Serializable id, String[] props);
	 ...
	 * @return property属性
	 */
	public abstract <T> PropertyDescriptor getPrimaryKeyProperty(Class<T> entityClass);
	 ...
	 */
	public abstract List<?> selectByValueBean(String queryString, Object valueBean);
	 ...
	 *             SQL异常产生时抛出
	 */
	public abstract List<?> selectForList(String statementName, Object parameterObject);
	 ...
	 *             SQL异常产生时抛出
	 */
	public abstract List<?> selectForList(String statementName, int skipResults, int maxResults);
	 ...
	 *             SQL异常产生时抛出
	 */
	public abstract List<?> selectForList(String statementName, Object parameterObject, int skipResults,
			int maxResults);
	 ...
	 *             如果查询到多条记录 ,或者其他的SQL异常
	 */
	public abstract Object selectForObject(String statementName, Object parameterObject);
	 ...
	 */
	public abstract void update(String statementName, Object parameterObject, int requiredRowsAffected);
	 ...
	 *            如果实际影响的行数和需要影响的行数不相等抛出
	 */
	public abstract void delete(String statementName, Object parameterObject, int requiredRowsAffected);
	 ...
	 */
	public abstract List<Map<String, Object>> selectForCamelCaseMap(String statementName) throws DaoException;

	// ////////////////////////////////////////////////////////////////////////////////
	public abstract List<Map<String, Object>> selectForMap(String sql);

	public abstract List<Map<String, Object>> selectForMap(String sql, Object value);

	public abstract List<Map<String, Object>> selectForMap(String sql, Object... values);
	 ...
	 * @return 查询语句返回的结果
	 */
	public abstract List<?> findByMappedQuery(String statementName, int firstResult, int maxResults);
	 ...
	 * @return 查询语句返回的结果
	 */
	public abstract List<?> findByMappedQuery(String statementName, Object parameterObject);
	 ...
	 *             当查询返回多条记录时抛出
	 */
	public abstract Object findByMappedQuerySingle(String statementName) throws DaoException;
	 ...
	 *             当查询返回多条记录时抛出
	 */
	public abstract Object findByMappedQuerySingle(String statementName, Object parameterObject) throws DaoException;
	 ...
	 * @return 语句返回的结果
	 */
	public abstract Object executeByMappedQuery(String statementName, Object parameterObject);
